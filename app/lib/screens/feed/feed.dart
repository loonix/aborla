...
import 'package:ABorla/widgets/card_widget.dart';
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        itemBuilder: (BuildContext ctx, int index) {
          return CardWidget(image: images[index], category: 'Veiculos', dateExpire: '10/01/2022', title: 'Bicicleta BMX jante 20', location: 'Mafemude, Vila Nova de Gaia');
        },
